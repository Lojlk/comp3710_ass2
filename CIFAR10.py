...
transform_train = transforms.Compose([
    transforms.ToTensor(), # converts an image to tensor
    transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),
    # Important step to create variance (by rotating, resizing, croping the images)
    transforms.RandomHorizontalFlip(), # regularisation of the data to fix accuracy and not fine tuning of hyperparameter tunning
